...
fn main_1() {
  ...
  u_xlat1 = (x_106 * vec4<f32>(0.45454546809196472168f, 0.45454546809196472168f, 0.45454546809196472168f, 2.5f));
  ...
  let x_131 : vec3<f32> = ((vec3<f32>(x_121.x, x_121.y, x_121.z) * vec3<f32>(0.30000001192092895508f, 0.30000004172325134277f, 0.30000001192092895508f)) + vec3<f32>(0.5f, 0.41999998688697814941f, 0.32499998807907104492f));
  ...
  let x_159 : vec2<f32> = (vec2<f32>(x_154.w, x_154.w) * vec2<f32>(0.04999999701976776123f, 0.03141592815518379211f));
  ...
  if (x_181) {
    ...
    u_xlat0.x = ((x_185 * x_187) + 0.05062496662139892578f);
    ...
    u_xlat14 = ((x_212 * 5.25f) + -6.80000019073486328125f);
    let x_217 : f32 = u_xlat7;
    let x_218 : f32 = u_xlat14;
    u_xlat14 = ((x_217 * x_218) + 3.8299999237060546875f);
    let x_222 : f32 = u_xlat7;
    let x_223 : f32 = u_xlat14;
    u_xlat14 = ((x_222 * x_223) + 0.45899999141693115234f);
    let x_227 : f32 = u_xlat7;
    let x_228 : f32 = u_xlat14;
    u_xlat7 = ((x_227 * x_228) + -0.0028699999675154686f);
    let x_232 : f32 = u_xlat7;
    u_xlat7 = (x_232 * 1.44269502162933349609f);
    let x_235 : f32 = u_xlat7;
    u_xlat0.y = exp2(x_235);
    let x_238 : vec3<f32> = u_xlat0;
    u_xlat0 = (vec3<f32>(x_238.x, x_238.y, x_238.x) * vec3<f32>(0.5f, 0.24603183567523956299f, 20.0f));
    ...
    u_xlat4 = ((x_249 * vec3<f32>(0.5f, 0.5f, 0.5f)) + vec3<f32>(0.0f, 1.00010001659393310547f, 0.0f));
    ...
    u_xlat22 = (x_264 * 230.831207275390625f);
    ...
    u_xlat23 = ((x_295 * 5.25f) + -6.80000019073486328125f);
    let x_299 : f32 = u_xlat16.x;
    let x_300 : f32 = u_xlat23;
    u_xlat23 = ((x_299 * x_300) + 3.8299999237060546875f);
    let x_304 : f32 = u_xlat16.x;
    let x_305 : f32 = u_xlat23;
    u_xlat23 = ((x_304 * x_305) + 0.45899999141693115234f);
    let x_309 : f32 = u_xlat16.x;
    let x_310 : f32 = u_xlat23;
    u_xlat16.x = ((x_309 * x_310) + -0.0028699999675154686f);
    let x_315 : f32 = u_xlat16.x;
    u_xlat16.x = (x_315 * 1.44269502162933349609f);
    let x_319 : f32 = u_xlat16.x;
    u_xlat16.x = exp2(x_319);
    let x_322 : f32 = u_xlat21;
    u_xlat21 = (-(x_322) + 1.0f);
    let x_325 : f32 = u_xlat21;
    u_xlat23 = ((x_325 * 5.25f) + -6.80000019073486328125f);
    let x_328 : f32 = u_xlat21;
    let x_329 : f32 = u_xlat23;
    u_xlat23 = ((x_328 * x_329) + 3.8299999237060546875f);
    let x_332 : f32 = u_xlat21;
    let x_333 : f32 = u_xlat23;
    u_xlat23 = ((x_332 * x_333) + 0.45899999141693115234f);
    let x_336 : f32 = u_xlat21;
    let x_337 : f32 = u_xlat23;
    u_xlat21 = ((x_336 * x_337) + -0.0028699999675154686f);
    let x_340 : f32 = u_xlat21;
    u_xlat21 = (x_340 * 1.44269502162933349609f);
    ...
    let x_372 : vec3<f32> = ((vec3<f32>(x_365.x, x_365.y, x_365.z) * vec3<f32>(x_367.y, x_367.y, x_367.y)) + vec3<f32>(0.012566370889544487f, 0.012566370889544487f, 0.012566370889544487f));
    ...
    u_xlat6 = (x_382 * vec3<f32>(1.44269502162933349609f, 1.44269502162933349609f, 1.44269502162933349609f));
    ...
    u_xlat22 = (x_409 * 230.831207275390625f);
    ...
    u_xlat4 = (x_533 * vec3<f32>(1.44269502162933349609f, 1.44269502162933349609f, 1.44269502162933349609f));
    ...
    u_xlat0 = (x_560 * vec3<f32>(0.01999999955296516418f, 0.01999999955296516418f, 0.01999999955296516418f));
  } else {
    let x_566 : f32 = u_xlat3.y;
    u_xlat21 = min(x_566, -0.00100000004749745131f);
    let x_570 : f32 = u_xlat21;
    u_xlat21 = (-0.00009999999747378752f / x_570);
    let x_572 : f32 = u_xlat21;
    let x_574 : vec3<f32> = u_xlat3;
    let x_576 : vec3<f32> = ((vec3<f32>(x_572, x_572, x_572) * x_574) + vec3<f32>(0.0f, 1.00010001659393310547f, 0.0f));
    ...
    u_xlat23 = ((x_594 * 5.25f) + -6.80000019073486328125f);
    let x_597 : f32 = u_xlat22;
    let x_598 : f32 = u_xlat23;
    u_xlat23 = ((x_597 * x_598) + 3.8299999237060546875f);
    let x_601 : f32 = u_xlat22;
    let x_602 : f32 = u_xlat23;
    u_xlat23 = ((x_601 * x_602) + 0.45899999141693115234f);
    let x_605 : f32 = u_xlat22;
    let x_606 : f32 = u_xlat23;
    u_xlat22 = ((x_605 * x_606) + -0.0028699999675154686f);
    let x_609 : f32 = u_xlat22;
    u_xlat22 = (x_609 * 1.44269502162933349609f);
    let x_611 : f32 = u_xlat22;
    u_xlat22 = exp2(x_611);
    let x_614 : f32 = u_xlat16.x;
    u_xlat16.x = (-(x_614) + 1.0f);
    let x_619 : f32 = u_xlat16.x;
    u_xlat23 = ((x_619 * 5.25f) + -6.80000019073486328125f);
    let x_623 : f32 = u_xlat16.x;
    let x_624 : f32 = u_xlat23;
    u_xlat23 = ((x_623 * x_624) + 3.8299999237060546875f);
    let x_628 : f32 = u_xlat16.x;
    let x_629 : f32 = u_xlat23;
    u_xlat23 = ((x_628 * x_629) + 0.45899999141693115234f);
    let x_633 : f32 = u_xlat16.x;
    let x_634 : f32 = u_xlat23;
    u_xlat16.x = ((x_633 * x_634) + -0.0028699999675154686f);
    let x_639 : f32 = u_xlat16.x;
    u_xlat16.x = (x_639 * 1.44269502162933349609f);
    let x_643 : f32 = u_xlat16.x;
    u_xlat16.x = exp2(x_643);
    let x_646 : f32 = u_xlat22;
    let x_650 : vec2<f32> = (vec2<f32>(x_646, x_646) * vec2<f32>(0.25f, 0.24990001320838928223f));
    ...
    let x_672 : vec3<f32> = ((vec3<f32>(x_669.x, x_669.z, x_669.w) * vec3<f32>(0.5f, 0.5f, 0.5f)) + vec3<f32>(0.0f, 1.00010001659393310547f, 0.0f));
    ...
    u_xlat21 = (x_685 * 230.831207275390625f);
    ...
    let x_705 : vec3<f32> = ((vec3<f32>(x_700.x, x_700.y, x_700.z) * vec3<f32>(x_702.y, x_702.y, x_702.y)) + vec3<f32>(0.012566370889544487f, 0.012566370889544487f, 0.012566370889544487f));
    ...
    let x_718 : vec3<f32> = (vec3<f32>(x_716.x, x_716.y, x_716.z) * vec3<f32>(1.44269502162933349609f, 1.44269502162933349609f, 1.44269502162933349609f));
    ...
    let x_738 : vec3<f32> = ((vec3<f32>(x_733.x, x_733.y, x_733.z) * vec3<f32>(x_735.x, x_735.x, x_735.x)) + vec3<f32>(0.01999999955296516418f, 0.01999999955296516418f, 0.01999999955296516418f));
