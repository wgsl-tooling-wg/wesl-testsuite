...
@group(0) @binding(1) var<storage, read_write> x_199 : x_Output_origX0X;
...
fn main_1() {
  ...
  u_xlati0 = select(1i, 0i, (x_189 != 0i));
  let x_193 : u32 = gl_LocalInvocationIndex;
  u_xlati2 = (bitcast<i32>(x_193) << bitcast<u32>(2i));
  let x_200 : i32 = u_xlati2;
  let x_202 : i32 = u_xlati0;
  x_199.x_Output_origX0X_buf[(x_200 >> bitcast<u32>(2i))] = bitcast<u32>(x_202);
  return;
}
